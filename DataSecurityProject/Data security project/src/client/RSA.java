...
public class RSA {
	 ...
	 */
	public static final String CLIENT_PRIVATE_KEY_FILE = "src/client/keys/clientPrivate.key";
	/**
	 * String to hold name of the public key file.
	 */
	public static final String CLIENT_PUBLIC_KEY_FILE = "src/client/keys/clientPublic.key";

	public static final String SERVER_PUBLIC_KEY_FILE = "src/client/keys/severPublic.key";
	...
	public static boolean areKeysPresent() {
		...
		File privateKey = new File(CLIENT_PRIVATE_KEY_FILE);
	...
	public static void generateKey() {
		...
		if (!areKeysPresent()) {
			...
			try {
				...
				ObjectInputStream publicKeyIS = new ObjectInputStream(new FileInputStream(CLIENT_PUBLIC_KEY_FILE));
				@SuppressWarnings("resource")
				ObjectInputStream privateKeyIS = new ObjectInputStream(new FileInputStream(CLIENT_PRIVATE_KEY_FILE));
...
//
//		byte[] cipher1 = doEncryption(plainB, CLIENT_PUBLIC_KEY_FILE, true);
//		String plainA1 = doDecryption(cipher1, CLIENT_PRIVATE_KEY_FILE, true);
//
//		byte[] cipher2 = doEncryption(plainB, CLIENT_PRIVATE_KEY_FILE, false);
//		String plainA2 = doDecryption(cipher2, CLIENT_PUBLIC_KEY_FILE, false);
